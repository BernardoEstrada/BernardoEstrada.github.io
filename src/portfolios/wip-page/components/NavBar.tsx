import { DEFAULT_DARK, DEFAULT_LIGHT, Themes, getThemeColors } from "@theme";
      ...
      <div className="join m-5 mr-0">
        <div className="btn join-item">
          <label className="swap swap-rotate">
            <input
              type="checkbox"
              checked={selectedTheme === DEFAULT_DARK}
              onChange={(e) => setSelectedTheme(e.target.checked ? DEFAULT_DARK : DEFAULT_LIGHT)}
            />
